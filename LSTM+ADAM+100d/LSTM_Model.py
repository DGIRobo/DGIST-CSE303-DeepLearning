...
class LSTM():
    def __init__(self, Nodes_at_each_layer, learningRate, beta1, beta2, epsilon, dropout_rate):
        self.Embedding_Layer = Embedding_Layer.Embedding_Layer(10, 100)
        self.LSTM_Layer1 = LSTM_Layer.LSTM_Layer(100, 128, Nodes_at_each_layer, learningRate, beta1, beta2, epsilon)
        self.Dropout_Layer1 = Dropout_Layer.Dropout_Layer(128, 128, Nodes_at_each_layer, dropout_rate)
        self.LSTM_Layer2 = LSTM_Layer.LSTM_Layer(128, 128, Nodes_at_each_layer, learningRate, beta1, beta2, epsilon)
        self.Dropout_Layer2 = Dropout_Layer.Dropout_Layer(128, 128, Nodes_at_each_layer, dropout_rate)
        self.Dense_Layer = Dense_Layer.Dense_Layer(128, 5, learningRate, beta1, beta2, epsilon)
